...
export default function StatsScreen() {
  ...
  return (
    <View className="flex-1 bg-cream dark:bg-night">
      ...
      >
        <View className="rounded-card border border-sand bg-cream p-5 dark:border-nightRaised dark:bg-nightSurface">
        ...
        {rows.length === 0 ? (
          <Text className="font-raleway text-ink-muted dark:text-ink-invmuted">
